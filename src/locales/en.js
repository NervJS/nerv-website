export default {
  ...
  size: 'Tiny',
  size_desc:
    "Nerv is only one thrid of React's size, this means less JavaScript to download, parse and execute.",
  perf: 'Performant',
  perf_desc:
    'Synchronous and deterministic diff algorithm makes Nerv one of the fastest Virtual DOM libraries.',
  ecos: 'Ecosystem',
  ecos_desc:
    'No need for `nerv-compat`, just addding a simple alias to your bundler provides even the most complex React components to be used in your application.',
  isom: 'Isomorphic',
